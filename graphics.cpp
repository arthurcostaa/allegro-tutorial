...
int main() {
    ...
    // Antialiasing - instructions to smoth the edges of primitives
            ...
            for(int i = 0; i < BT_N; i++) {
                ...
                switch(b->type) {
                    ...
                    case BT_RECTANGLE_2:
                        ...
                        v[0].y = b->y;
                        v[0].z = 0;
                        v[0].color = al_map_rgb_f(1, 0, 0);

                        v[1].x = b->x + 120;
                        v[1].y = b->y;
                        v[1].z = 0;
                        v[1].color = al_map_rgb_f(0, 1, 0);

                        v[2].x = b->x;
                        v[2].y = b->y + 100;
                        v[2].z = 0;
                        v[2].color = al_map_rgb_f(0, 0, 1);

                        v[3].x = b->x + 120;
                        v[3].y = b->y + 100;
                        v[3].z = 0;
                        v[3].color = al_map_rgb_f(1, 1, 0);
